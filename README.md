...
An expansion of KerbalFoundries2 by ***shadowmage45*** which includes the updated ***BahamutoD*** Adjustable Landing Gear mod. 

- Adds side folding variations of Medium and Large sizes, and a ***brand new Extra Large*** size with triple wheel bogeys.
- Each size can be found in standard folding, side folding, and ***brand new Housing-Less*** versions of both standard and side folding.
...
- Includes optional patches for refining the original versions of the landing gear.
<br>
...
- Small
  - Standard (_Base Mod_)
  - Side folding (_Base Mod_)
  - **Housing-less**

###### Bold text indicates expansion part...
<br>

## Side Folding Variants

New Medium and Large sizes, as well as Extra Large

<img height="380" alt="v1,1 side fold lineup" src="https://github.com/user-attachments/assets/2d8d62c2-6a0e-41a9-9a09-3ac75f2b33fa" />

<br>

## Housing-Less Variants
